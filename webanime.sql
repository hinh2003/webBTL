...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 30, 2023 lúc 09:31 PM
...
(106, 'hino20031', 'ngocnhilove4321@gmail.com', '$2y$10$/1MG.Y1ub.Z8stgc6T5RL.nrzw/7gzHyl.W7CbfGdZJYolPxB.t9e', '2023-12-30 12:23:09', 3),
(107, 'hinh2003123456', 'hinh2003123456@gmail.com', '$2y$10$r2xxrCLHTiKzfpsWsGSS9u5senr8h1hy1pgAIyFOp1VXR/WzyIY5m', '2023-12-30 12:24:27', 3),
(109, 'hinh20031', 'vanhinh200312@gmail.com', '$2y$10$e4kKU2fPJm28lOUQOljzdetBw892c/nOomfLh0yArZKKJp2rKbwUy', '2023-12-31 02:09:56', 3);
...
(82, 'BUTA NO LIVER WA KANETSU SHIRO', 14, 'BUTA NO LIVER WA KANETSU SHIRO.avif', '2023', 'Phim rat hay', 1, 1);
...
ALTER TABLE `theloaiphim`
  ...
  ADD KEY `phim_id` (`phim_id`),
  ADD KEY `fk_theloai_id` (`theloai_id`);
...
--
ALTER TABLE `nguoidung`
  MODIFY `nguoidung_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
...
--
ALTER TABLE `phim`
  MODIFY `phim_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT cho bảng `phim_yeuthich`
--
ALTER TABLE `phim_yeuthich`
  MODIFY `yeuthich_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
ALTER TABLE `theloai`
  MODIFY `theloai_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT cho bảng `theloaiphim`
--
ALTER TABLE `theloaiphim`
  MODIFY `theloaiphim_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;
...
--
ALTER TABLE `phim_yeuthich`
  ADD CONSTRAINT `fk_phim_id` FOREIGN KEY (`phim_id`) REFERENCES `phim` (`phim_id`) ON DELETE CASCADE,
...
--
ALTER TABLE `theloaiphim`
  ADD CONSTRAINT `fk_theloai_id` FOREIGN KEY (`theloai_id`) REFERENCES `theloai` (`theloai_id`) ON DELETE CASCADE,
